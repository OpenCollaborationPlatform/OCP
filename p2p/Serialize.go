//this is pretty much copied from nexus wamp implementation
package p2p
...
func Deserialize(data []byte) (Message, error) {
	...
	return listToMsg(MessageType(typ), v)
}
...
// listToMessage takes a list of values from a p2p message and populates the
// fields of a message type.
func listToMsg(msgType MessageType, vlist []interface{}) (Message, error) {
...
func msgToList(msg Message) []interface{} {
	val := reflect.ValueOf(msg)
	if val.Kind() == reflect.Ptr {
		val = val.Elem()
	}
